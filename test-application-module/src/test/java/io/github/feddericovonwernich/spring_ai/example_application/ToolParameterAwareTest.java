...
import io.github.feddericovonwernich.spring_ai.example_application.services.TestService;
...
public class ToolParameterAwareTest {
    ...
    public void testToolCallPrimitiveParam() {
        try {
            Method methodArgument = TestService.class.getDeclaredMethod("generateGreeting", String.class, String.class);
            String parameters = """
    ...
    public void testToolCallObjectParam() {
        try {
            Method methodArgument = TestService.class.getDeclaredMethod("printPersonInfo", Person.class);
            String parameters = """
    ...
    public void testToolCallListsParam() {
        try {
            Method methodArgument = TestService.class.getDeclaredMethod("concatenateList", List.class);
            String parameters = """
